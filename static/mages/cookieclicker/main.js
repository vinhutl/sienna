...
Game.Launch=function()
{
	...
	Game.ErrorFrame=function()
	{
		...
		'<div class="title">Note from dev</div>'+
		'<div>So Cookie Clicker doesn\'t like when you open it in an iframe so<br>'+
		'You can use <a href="/mages/cookieclicker/index.html" target="_blank">this link to open Cookie Clicker</a><br>'+
		'<small>Have fun playing Cookie Clicker on Night.</small></div>';
	}
	Game.timedout=false;
                ...
                return function () {
                    ...
                    LoadLang('loc/' + lang + '.js?v=' + Game.version, function () {
                        var launch = function () {
                            ...
                            // ⬇️ Removed the iframe check that called Game.ErrorFrame()
                            console.log('[=== ' + choose([
                                'Oh, hello!',
                                'hey, how\'s it hangin',
